...
$sql_res=mysqli_query($mysqli, 'SELECT COUNT(*) FROM std_941.services');
...
$sql='SELECT * FROM std_941.services LIMIT '.$diapazon.', 10';
if ($_GET['sort'] == 'fam')
$sql='SELECT * FROM std_941.services ORDER BY price LIMIT '.$diapazon.', 10';
if ($_GET['sort'] == 'birth')
$sql='SELECT * FROM std_941.services ORDER BY price LIMIT '.$diapazon.', 10';
...
$ret.='<div class="card" style="padding:3%;"><h3>'.$row['name'].'</h3>
<p>'.$row['price'].'р.</p>
<p>'.$row['about'].'</p></div>';
}
